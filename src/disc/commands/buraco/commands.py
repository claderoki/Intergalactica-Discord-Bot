...
from src.disc.commands.buraco.game import CardSequence
...
class GameMenu(discord.ui.View):
    def __init__(self, players: List[Player], min_players: int = 2, settings: Optional[GameSettings] = None):
        ...
        # todo: should be multiplied based on the amount of players
        self._deck = Deck.standard54() * 2
        self._load()
...
@config.tree.command(name="buraco", description="Play Buraco")
async def buraco(interaction: discord.Interaction, min_players: Optional[int] = 2):
    cards = [
