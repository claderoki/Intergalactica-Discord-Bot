...
class DiscordUI(UI):
    ...
    def get_base_embed(self, **kwargs):
        ...
        embed.set_author(name=self.ctx.translate("slot_machine"),
                         icon_url="https://cdn.discordapp.com/attachments/744172199770062899/765694715596242964/slot-machine2.png")
        return embed
